    ...
    <div className="rounded-xl p-4 animate-fade-in"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        {stats.map((s) => (
          <div
            key={s.label}
            className="flex flex-col gap-1.5 p-3 rounded-lg overflow-hidden"
          ...
          >
            ...
            {/* Value — truncate if it overflows */}
            <div className="flex items-baseline gap-0.5 min-w-0">
              ...
              <span
                ...
                style={{ color: s.color, fontFamily: "var(--font-mono)" }}
                title={s.value}   /* full value on hover */
              >
                {s.value}
              </span>
              {s.unit && (
                <span className="text-xs shrink-0 ml-0.5"
                  style={{ color: "var(--text-muted)", fontFamily: "var(--font-body)" }}>
                  {s.unit}
                </span>
              )}
